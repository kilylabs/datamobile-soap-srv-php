...
class Wsdl28 extends AbstractWsdl
{
...
<definitions xmlns="http://schemas.xmlsoap.org/wsdl/"
	...
	<types>
		<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema"
			...
			<xs:complexType name="DMNewDataStruct">
				<xs:sequence>
					...
					<xs:element name="DMClearArtMarks"
							type="xs:boolean"/>
					<xs:element name="DMNewSNTypes"
							type="xs:boolean"/>
					<xs:element name="DMClearSNTypes"
							type="xs:boolean"/>
				</xs:sequence>
			</xs:complexType>
			...
			<xs:element name="GetSNTypesResponse">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="return"
								type="xs:string"/>
			...
			<xs:element name="GetSNListResponse">
				<xs:complexType>
					<xs:sequence>
						<xs:element name="return"
								type="xs:string"/>
	...
	<message name="GetSNTypesRequestMessage">
		<part name="parameters"
				element="tns:GetSNTypes"/>
	</message>
	<message name="GetSNTypesResponseMessage">
		<part name="parameters"
				element="tns:GetSNTypesResponse"/>
	</message>
	<message name="GetSNListRequestMessage">
		<part name="parameters"
				element="tns:GetSNList"/>
	</message>
	<message name="GetSNListResponseMessage">
		<part name="parameters"
				element="tns:GetSNListResponse"/>
	</message>
	<portType name="DataMobileExchPortType">
		...
		<operation name="GetSNTypes">
			<input message="tns:GetSNTypesRequestMessage"/>
			<output message="tns:GetSNTypesResponseMessage"/>
		</operation>
		<operation name="GetSNList">
			<input message="tns:GetSNListRequestMessage"/>
			<output message="tns:GetSNListResponseMessage"/>
		</operation>
	</portType>
	<binding name="DataMobileExchSoapBinding"
		...
		<operation name="GetSNTypes">
			<soapbind:operation style="document"
					soapAction="http://www.data-mobile.ru#DataMobileExch:GetSNTypes"/>
			<input>
				<soapbind:body use="literal"/>
			</input>
			<output>
		...
		<operation name="GetSNList">
			<soapbind:operation style="document"
					soapAction="http://www.data-mobile.ru#DataMobileExch:GetSNList"/>
			<input>
				<soapbind:body use="literal"/>
			</input>
			<output>
